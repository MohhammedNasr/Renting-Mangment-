...
public class apartment16_edit extends AppCompatActivity {

    public static final String FILE_NAME = "data16.txt";
    public static final String FILE_PHONE = "dataphone16.txt";
    EditText input_name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_apartment16_edit);
