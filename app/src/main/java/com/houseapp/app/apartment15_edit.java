...
public class apartment15_edit extends AppCompatActivity {

    public static final String FILE_NAME = "data15.txt";
    public static final String FILE_PHONE = "dataphone15.txt";
    EditText input_name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_apartment15_edit);
