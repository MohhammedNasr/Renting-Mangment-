...
public class apartment9_edit extends AppCompatActivity {

    public static final String FILE_NAME = "data9.txt";
    public static final String FILE_PHONE = "dataphone9.txt";
    EditText input_name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_apartment9_edit);
