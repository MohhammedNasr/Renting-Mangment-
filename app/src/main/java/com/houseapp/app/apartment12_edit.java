...
public class apartment12_edit extends AppCompatActivity {

    public static final String FILE_NAME = "data12.txt";
    public static final String FILE_PHONE = "dataphone12.txt";
    EditText input_name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_apartment12_edit);
