...
public class apartment4_edit extends AppCompatActivity {

    public static final String FILE_NAME = "data4.txt";
    public static final String FILE_PHONE = "dataphone4.txt";
    EditText input_name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_apartment4_edit);
