...
public class apartment11_edit extends AppCompatActivity {

    public static final String FILE_NAME = "data11.txt";
    public static final String FILE_PHONE = "dataphone11.txt";
    EditText input_name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_apartment11_edit);
