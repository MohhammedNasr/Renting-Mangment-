...
public class apartment6_edit extends AppCompatActivity {

    public static final String FILE_NAME = "data6.txt";
    public static final String FILE_PHONE = "dataphone6.txt";
    EditText input_name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_apartment6_edit);
