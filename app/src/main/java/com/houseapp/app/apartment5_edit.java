...
public class apartment5_edit extends AppCompatActivity {

    public static final String FILE_NAME = "data5.txt";
    public static final String FILE_PHONE = "dataphone5.txt";
    EditText input_name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_apartment5_edit);
