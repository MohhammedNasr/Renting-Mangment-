...
public class apartment14_edit extends AppCompatActivity {

    public static final String FILE_NAME = "data14.txt";
    public static final String FILE_PHONE = "dataphone14.txt";
    EditText input_name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_apartment14_edit);
