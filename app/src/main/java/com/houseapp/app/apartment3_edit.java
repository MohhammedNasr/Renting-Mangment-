...
public class apartment3_edit extends AppCompatActivity {

    public static final String FILE_NAME = "data3.txt";
    public static final String FILE_PHONE = "dataphone3.txt";
    EditText input_name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_apartment3_edit);
