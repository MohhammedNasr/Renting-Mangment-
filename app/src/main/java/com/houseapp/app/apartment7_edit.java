...
public class apartment7_edit extends AppCompatActivity {

    public static final String FILE_NAME = "data7.txt";
    public static final String FILE_PHONE = "dataphone7.txt";
    EditText input_name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_apartment7_edit);
