...
public class apartment1_edit extends AppCompatActivity {

    public static final String FILE_NAME = "data.txt";
    public static final String FILE_PHONE = "dataphone.txt";
    EditText input_name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_apartment1_edit);
