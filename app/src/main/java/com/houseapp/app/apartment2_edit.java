...
public class apartment2_edit extends AppCompatActivity {

    public static final String FILE_NAME = "dataa.txt";
    public static final String FILE_PHONE = "dataphonee.txt";
    EditText input_name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_apartment2_edit);
