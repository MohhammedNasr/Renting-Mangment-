...
public class apartment13_edit extends AppCompatActivity {

    public static final String FILE_NAME = "data13.txt";
    public static final String FILE_PHONE = "dataphone13.txt";
    EditText input_name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_apartment13_edit);
