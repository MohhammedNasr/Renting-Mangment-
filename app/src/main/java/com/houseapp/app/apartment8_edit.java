...
public class apartment8_edit extends AppCompatActivity {

    public static final String FILE_NAME = "data8.txt";
    public static final String FILE_PHONE = "dataphone8.txt";
    EditText input_name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_apartment8_edit);
